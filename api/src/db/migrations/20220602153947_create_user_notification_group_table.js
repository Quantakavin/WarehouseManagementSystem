...
exports.up = function(knex) {
    return knex.schema.createTable('UserNotiGroup', function(table) {
        ...
        table.foreign('UserID').references('UserID').inTable('User').onDelete('cascade').onUpdate('cascade');
        table.foreign('NotiGroupID').references('NotiGroupID').inTable('NotiGroup').onDelete('cascade').onUpdate('cascade');
