...
router.post('/notificationgroup', validation.validateNotificationGroup, notificationGroupController.createNotificationGroup);
router.put('/notificationgroup/:id', validation.validateNotificationGroup, notificationGroupController.updateNotificationGroup);
