...
router.post('/usergroup', authorization.verifyAdmin, validation.validateUserGroup, userGroupController.createUserGroup);
router.put('/usergroup/:id', authorization.verifyAdmin, validation.validateUserGroup, userGroupController.updateUserGroup);
