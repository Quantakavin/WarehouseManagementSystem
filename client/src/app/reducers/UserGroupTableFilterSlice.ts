...
export const { ChangeSortColumn, SortDesc, SortAsc } = UserGroupTableFilterSlice.actions

// Other code such as selectors can use the imported `RootState` type
export const selectSortColumn = (state: RootState) => state.userGroupTableFilter.sortColumn
export const selectSortOrder = (state: RootState) => state.userGroupTableFilter.sortOrder
