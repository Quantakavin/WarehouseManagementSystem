...
export const { ChangeSortColumn, SortDesc, SortAsc } = NotiGroupTableFilterSlice.actions

// Other code such as selectors can use the imported `RootState` type
export const selectSortColumn = (state: RootState) => state.notiGroupTableFilter.sortColumn
export const selectSortOrder = (state: RootState) => state.notiGroupTableFilter.sortOrder
