...
export const { ChangeSortColumn, SortDesc, SortAsc } = UserTableFilterSlice.actions

// Other code such as selectors can use the imported `RootState` type
export const selectSortColumn = (state: RootState) => state.userTableFilter.sortColumn
export const selectSortOrder = (state: RootState) => state.userTableFilter.sortOrder
