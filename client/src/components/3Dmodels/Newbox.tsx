...
const Model: React.FC<ModelProps> = ({
  ...
  return (
    ...
    onPointerOut={() => setIsSelected(false)} ref={group} dispose={null}
    position={position}
    scale={[2.5, 2.5, 2.5]}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          <group position={[0, 0, 744.07]}>
            <mesh geometry={nodes.CrateB022_CrateB_lp_0.geometry} material={materials.CrateB_lp} position={[-982.05, 0, 0]} >
                      {isSelected ? (
