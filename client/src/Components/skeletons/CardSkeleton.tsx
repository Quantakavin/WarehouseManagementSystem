...
const CardContainer: React.FC<SkeletonProps> = ({NoOfFields}) => {
    ...
    return(
        <Container className="cardcontainer shadow">
            <Skeleton variant="rectangular" width={"30%"} height={22} sx={{marginBottom: "15px", marginTop: "10px"}}/>
            <Skeleton variant="rectangular" width={"20%"} height={18} sx={{marginBottom: "30px"}}/>
            {/* {
