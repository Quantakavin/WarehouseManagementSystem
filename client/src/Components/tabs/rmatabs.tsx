...
export default function RMATabs() {
  ...
  const applyLoan = () => {
    ...
    return <button onClick={apply}>Apply new RMA</button>;
  };
  ...
  return (
    <div>
      <Tabs>
        ...
        <TabPanel>
          <div key="pending">{getPending()}</div>
        </TabPanel>
        <TabPanel>
          <div key="approved">{getApproved()}</div>
        </TabPanel>
        <TabPanel>
          <div key="verified">{getReceived()}</div>
        </TabPanel>
        <TabPanel>
          <div key="verified">{getVerified()}</div>
        </TabPanel>
      </Tabs>
