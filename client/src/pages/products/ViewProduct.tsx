...
const ViewProduct: React.FC = () => {
  ...
  return (
    ...
    <CardContainer header={ProductQuery.data.data[0].ItemName} subheading={ProductQuery.data.data[0].ItemCode}>
      ...
      <CardField label="Bin Tag:" value={ProductQuery.data.data[0].BinID} />
